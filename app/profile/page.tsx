...
export default function ProfilePage() {
  ...
  const percent = Math.round((user.correct / user.total) * 100);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-blue-900 p-6 pb-28 text-white">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        {[
          { label: "Test", value: user.tests, color: "from-green-400 to-emerald-500" },
          { label: "Natija", value: percent + "%", color: "from-blue-400 to-cyan-500" },
          { label: "Daraja", value: level, color: "from-purple-400 to-pink-500" },
          { label: "XP", value: user.xp, color: "from-yellow-400 to-orange-500" },
        ].map((item, i) => (
          <motion.div
            key={i}
      ...
      >
        <p className="text-xl font-bold">🔥 {user.streak} kun</p>
        <p className="text-sm opacity-80">Ketma-ket o‘rganish</p>
      </motion.div>

      {/* 📈 PROGRESS */}
      <div className="bg-white/10 backdrop-blur-xl p-4 rounded-2xl mb-6">
        <p className="text-sm mb-2">Level progress</p>
